package com.mio.GUI.notification;
...
public class Notification extends javax.swing.JComponent {
    ...
    public Notification(Frame fram, Type type, Location location, String message) {
        ...
        initComponents();
        lbMessage.setFont(lbMessage.getFont().deriveFont(Font.BOLD, 16));
        init(message);
        initAnimator();
    }
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mio/GUI/notification/sucess.png")));
            lbMessage.setText("通知");
        } else if (type == Type.INFO) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mio/GUI/notification/info.png")));
            lbMessage.setText("通知");
        } else {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mio/GUI/notification/warning.png")));
            lbMessage.setText("通知");
        }
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mio/GUI/notification/sucess.png"))); // NOI18N
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mio/GUI/notification/close.png"))); // NOI18N
