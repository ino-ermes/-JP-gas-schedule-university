...
public class AdminFormShowSchedule extends javax.swing.JPanel {
    ...
    public AdminFormShowSchedule() {
        initComponents();
        menuSplit1.setText("スケジュール");
        cbxType.setModel(new DefaultComboBoxModel(new String[]{"教師", "学生グループ", "教室"}));
        ...
        if (action) {
            ...
            try {
                ...
                if (ImageIO.write(bImg, "png", new File(name))) {
                    new MessageDialog(Main.getInstance(), "エクスポート成功", false).showDialog();
