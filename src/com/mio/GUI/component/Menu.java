...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenu(MenuEvent event, User.UserRole userRole) {
        ...
        switch (userRole) {
            case ADMIN -> {
                addMenu("icons8-security-pass-16", "個人情報", 0);
                addMenu("icons8-department-16", "学部", 1);
                addMenu("icons8-physics-book-16", "科目", 2);
                addMenu("icons8-program-16", "教育課程", 3);
                addMenu("icons8-group-16", "学生グループ", 4);
                addMenu("icons8-room-16", "教室", 5);
                addMenu("icons8-schedule-16", "スケジュール", 6);
                addMenu("icons8-scheduling-16", "スケジューリング", 7);
            }
            case TEACHER -> {
