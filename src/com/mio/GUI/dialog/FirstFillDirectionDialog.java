...
public class FirstFillDirectionDialog extends JDialog {
    ...
    public FirstFillDirectionDialog(java.awt.Frame parent, boolean isRight) {
        super(parent, true);
        initComponents();
        lblInfor.setFont(lblInfor.getFont().deriveFont(Font.PLAIN, 16));
        ...
        if(isRight) {
            lblInfor.setText("続くには確認ボタンを押してください");
        } else {
            lblInfor.setText("全ての教師はまだクラスに割り当てられていません！");
