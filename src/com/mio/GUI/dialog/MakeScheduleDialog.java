...
public final class MakeScheduleDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        panelBorder2Layout.setHorizontalGroup(
            ...
            .addGroup(panelBorder2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(scroll, javax.swing.GroupLayout.DEFAULT_SIZE, 750, Short.MAX_VALUE)
    ...
    private void btnApplyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApplyActionPerformed
        ...
        if(Algorithm.getInstance().getFittest().getFitness() <= 1) {
            if(new MessageDialog(this, "制約を満たしていないクラスがまだいくつかあります。 続けたいですか？", true).showDialog()) {
                rtn = new HashMap<>();
