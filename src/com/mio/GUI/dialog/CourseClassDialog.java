...
public class CourseClassDialog extends JDialog {
    ...
    public CourseClassDialog(java.awt.Frame parent, CourseClass cc, boolean isIncludeSchedule) {
        ...
        String[] day = {"月曜日", "火曜日", "水曜日", "木曜日", "金曜日", "土曜日"};
        String[] time = {"1限", "2限", "3限", "4限", "5限", "6限", "7限", "8限", "9限", "10限"};
    ...
    private void initComponents() {
        ...
        label6.setText("学生グループ");

        btnGroup.setText("学生グループを選択");
        ...
        label7.setText("学生の人数");

        rdbRequireLab.setText("コンピューターのある教室をリクエストする");

        lblRoom.setText("教室");

        lblTime.setText("○曜日ー○限");

        lblWeek.setText("○週目～○週目");

        btnOkWithoutSchedule.setText("＊Ok＊");
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(good)
            ...
            new MessageDialog(this, "記入した情報が間違っています。直して、もう一度お試しください。", false).showDialog();
