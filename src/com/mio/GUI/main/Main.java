...
public class Main extends javax.swing.JFrame {
    ...
    public void showNotification(NotificationType t) {
        switch (t) {
            case ADD_FAILED -> {
                new Notification(this, Notification.Type.WARNING, Notification.Location.TOP_CENTER, "追加失敗しました").showNotification();
            }
            case UPDATE_FAILED -> {
                new Notification(this, Notification.Type.WARNING, Notification.Location.TOP_CENTER, "編集失敗しました").showNotification();
            }
            case DELETE_FAILED -> {
                new Notification(this, Notification.Type.WARNING, Notification.Location.TOP_CENTER, "削除失敗しました").showNotification();
            }
        }
