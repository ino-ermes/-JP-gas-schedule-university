...
public class LoginMain extends javax.swing.JFrame {
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        if(user == null) {
            new Notification(this, Notification.Type.WARNING, Notification.Location.TOP_RIGHT, "ログイン情報が間違っています！").showNotification();
        } else {
            password.setText("");
            setVisible(false);
            LoginMain me = this;
...
//        setUIFont(new javax.swing.plaf.FontUIResource("ＭＳ ゴシック", Font.PLAIN, 20));

//        UIManager.getLookAndFeelDefaults().put("defaultFont", new Font("ＭＳ ゴシック", Font.PLAIN, 20));

        try {
            UIManager.setLookAndFeel("javax.swing.plaf.nimbus.NimbusLookAndFeel");

            UIManager.getLookAndFeelDefaults().put("defaultFont", new Font("ＭＳ ゴシック", Font.PLAIN, 16));
        ...
        try {
            ...
            new MessageDialog(null, "データベースに直接できません！", false);
            return;
        }

        // Create and display the form
        java.awt.EventQueue.invokeLater(() -> new LoginMain().setVisible(true));
    }
